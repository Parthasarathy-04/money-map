export const translations = {
  en: {
    ...
    about: 'About Us',
    // Landing
    welcome: 'Welcome to MoneyMap',
    subtitle: 'Track your expenses. Understand your spending.',
    getStarted: 'Get Started',
    // Login
    loginToMoneyMap: 'Login to MoneyMap',
    email: 'Email',
    password: 'Password',
    loginBtn: 'Login',
    ...
    // Register
    registerToMoneyMap: 'Register to MoneyMap',
  ...
  bn: {
    ...
    // Login
    loginToMoneyMap: 'কিপ্টায় লগইন করুন',
    email: 'ইমেইল',
    password: 'পাসওয়ার্ড',
    loginBtn: 'লগইন',
    ...
    // Register
    registerToMoneyMap: 'কিপ্টায় রেজিস্টার করুন',
